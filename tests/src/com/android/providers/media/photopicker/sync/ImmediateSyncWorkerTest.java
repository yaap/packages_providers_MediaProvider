...
public class ImmediateSyncWorkerTest {
    ...
    @Test
    public void testLocalImmediateSync()
    ...
    @Test
    public void testCloudImmediateSync()
            throws ExecutionException, InterruptedException, InvalidProviderSyncParamsException {
        // Setup
        PickerSyncController.setInstance(mMockPickerSyncController);
    ...
    @Test
    public void testLocalAndCloudImmediateSync()
            throws ExecutionException, InterruptedException, InvalidProviderSyncParamsException {
        // Setup
        PickerSyncController.setInstance(mMockPickerSyncController);
        final OneTimeWorkRequest request  =
    ...
    public void testImmediateCloudSyncInvalidParamsTriggerRetry() throws
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_CMP_IMPROVEMENTS)
    public void testLocalImmediateSyncNoFallback() throws
            ExecutionException, InterruptedException, InvalidProviderSyncParamsException {
        PickerSyncController.setInstance(mMockPickerSyncController);
        final OneTimeWorkRequest request =
                new OneTimeWorkRequest.Builder(ImmediateSyncWorker.class)
